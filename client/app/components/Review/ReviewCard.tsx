...
const ReviewCard: FC<Props> = ({ item, key }) => {
  return (
    <div
      key={key}
      className="w-full h-max pb-4 dark:bg-slate-500 dark:bg-opacity-[0.2] border border-[#00000028] dark:border-[#ffffff1d] backdrop-blur shadow-[bg-slate-700] rounded-lg p-3 shadow-inner"
    >
